...
class MyString5{
	...
	private String packet1 = "SAname=A01prive==003000num=001ED";			// 아메리카노 1잔 3000원
	private String packet2 = "SAname=A02prive==003500num=002ED";			// 카페라떼 2잔 3500원
	private String packet3 = "SAname=A03prive==004000num=004ED";			// 카페모카 4잔 4000원
	...
	public void parsing(String packet) {
		...
		num = Integer.parseInt(packet1.substring(26, 29));
		price = Integer.parseInt(packet1.substring(16, 22));
		price_sum = num*price;
